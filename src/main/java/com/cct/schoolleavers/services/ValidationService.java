 ...
 * Validation Service
 * 
 * This service provides simple form validation functionality
...
public class ValidationService {
    ...
    public boolean validateSchoolLeaverForm(SchoolLeaverDto schoolLeaverDto, BindingResult bindingResult) {
        ...
        if (schoolLeaverDto.getStatisticCode() == null || schoolLeaverDto.getStatisticCode().trim().isEmpty()) {
        ...
        if (schoolLeaverDto.getStatisticLabel() == null || schoolLeaverDto.getStatisticLabel().trim().isEmpty()) {
        ...
        // Validate quarter
        if (schoolLeaverDto.getQuarter() == null || schoolLeaverDto.getQuarter().trim().isEmpty()) {
        ...
        // Validate sex
        if (schoolLeaverDto.getSex() == null || schoolLeaverDto.getSex().trim().isEmpty()) {
        ...
        // Validate unit
        if (schoolLeaverDto.getUnit() == null || schoolLeaverDto.getUnit().trim().isEmpty()) {
    ...
    public String sanitizeInput(String input) {
        ...
        // Simple trim for a simple system
        return input.trim();
    }
    ...
    public SchoolLeaverDto sanitizeSchoolLeaverData(SchoolLeaverDto schoolLeaverDto) {
        ...
        sanitized.setValue(schoolLeaverDto.getValue());
